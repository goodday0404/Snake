...
**************************************************************************************/
const string UserID = "User ID: kjjeon";
const string StudentNumber = "Student Number: 2039 5036";
const string Name = "Name: Kyoung Jin Jeon";
...
void splashScreen(XInfo &xinfo) {
	...
	drawString(xinfo,20,20,UserID,Blue,stringSize);
	drawString(xinfo,20,40,"",Blue,stringSize);
	drawString(xinfo,20,60,StudentNumber,Blue,stringSize);
	drawString(xinfo,20,80,"",Blue,stringSize);
	drawString(xinfo,20,100,Name,Blue,stringSize);
